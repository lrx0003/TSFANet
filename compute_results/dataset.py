...
class ORSSD(data.Dataset):
    def __init__(self, root, mode, aug=False):
        ...
        self.label_paths = [os.path.join(root, 'labels', prefix + '.jpg') for prefix in self.prefixes]
        self.edge_paths = [os.path.join(root, 'edges', prefix + '.jpg') for prefix in self.prefixes]
...
class EORSSD(data.Dataset):
    def __init__(self, root, mode, aug=False):
        ...
        self.label_paths = [os.path.join(root, 'label', prefix + '.jpg') for prefix in self.prefixes]
