...
if __name__ == '__main__':  
    ...
    for method_name in method_names:
        for dataseti in dataset_name:
            ...
            root = "../data/EORSSD/test"
            smap_path = "./" + method_name + "_" + dataseti + "/"
            ...
            thread = Eval_thread(smap_path=smap_path, loader = test_loader, method = method_name, dataset = dataseti, output_dir = "./output/", cuda=False)#backbone_ablation/
            logg, fm = thread.run()
            print(logg)
